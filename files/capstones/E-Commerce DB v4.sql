...
Select p.*, c.categoryname from product_tbl p join ctgry_tbl c on p.categoryid = c.categoryid where c.categoryname in ('Action','Adventure','Simulation');
...
insert into product_tbl values (2000, 'Summertime Saga', 2750, 1001, 'UBISOFT', '21-Oct-2021', 10, 0, 'The son is pervert', null,'Adventure');
