...
--insert into cart_tbl values(41002, 102, '25-Apr-2022');
...
--insert into payment_tbl values (20001, 41001, 3900, 275,'John Doe', 218381647, 414, '30-May-2022', 'Cash on Delivery');

select * from payment_tbl;

drop table payment_tbl;
drop table cart_tbl;
drop table PromotionalEvent_tbl;
drop table product_tbl;
drop table userdetails_tbl;
drop table admin_tbl;
drop table user_tbl;
drop table ctgry_tbl;